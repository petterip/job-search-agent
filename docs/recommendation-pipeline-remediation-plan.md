...
| P0-3 review backlog | partial / blocked | Dry-run inventory is publication-independent and freezes expected request identities; `run_review_backfill` refuses paid execution without an explicit authorization flag and budget. The resumable paid backfill is not executed and is blocked on explicit authorization. Tests: PG publication tests. |
...
| P1-3, P1-5, P1-7a-c, P1-8a-c, P1-9a, P1-10, P1-11, P1-13, P2-1, P2-2, P2-4, P2-6, P2-7, P2-8 (full), P2-11, P2-16, P2-22, P2-23 | not implemented | Remaining backlog; see the task sections for dependencies. |
