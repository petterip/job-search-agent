...
| P1-6 discovery terms | partial | Phrase-based terms, dedupe, bounded budget with a coverage warning, learned discovery queries wired into the pool with `learned_discovery` lane provenance. Full before/after labelled comparison remains. Tests: `tests/test_matching.py`. |
...
| P1-5, P1-6 (full), P1-7b, P1-7c, P1-8a-c, P1-9a, P1-10, P1-11, P2-1, P2-2, P2-6, P2-7, P2-22, P2-23 | not implemented | Remaining backlog; see the task sections for dependencies. |
